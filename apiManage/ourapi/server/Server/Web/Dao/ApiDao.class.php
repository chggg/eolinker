...
class ApiDao
{
    ...
    public function getApi(&$apiID)
    {
        ...
        if(defined('MOCK_URL')){ //zjh
            $apiJson['baseInfo']['successMockURL'] = MOCK_URL . $_SERVER['SCRIPT_NAME'] . '?g=Web&c=Mock&o=simple' . $apiJson['baseInfo']['mockCode'];
            $apiJson['baseInfo']['failureMockURL'] = MOCK_URL . $_SERVER['SCRIPT_NAME'] . '?g=Web&c=Mock&o=simple&resultType=failure' . $apiJson['baseInfo']['mockCode'];
        }else{
        ...
        if(defined('MOCK_URL')){ //zjh
            $apiJson['mockInfo']['mockURL'] = MOCK_URL . $_SERVER['SCRIPT_NAME'] . '?g=Web&c=Mock&o=mock' . $apiJson['baseInfo']['mockCode'];
        }else{
    ...
    public function getApiMockData(&$api_id)
    {
        ...
        if (empty($result)) {
            ...
            if(defined('MOCK_URL')){ //zjh
                $result['mockURL'] = MOCK_URL . $_SERVER['SCRIPT_NAME'] . '?g=Web&c=Mock&o=mock' . $mockCode;
            }else{
