<?php
//主机地址
defined('DB_URL') or define('DB_URL', '192.168.0.18');

//主机端口,默认mysql为3306
defined('DB_PORT') or define('DB_PORT', '63306');

//连接数据库的用户名
defined('DB_USER') or define('DB_USER', 'ysb');

//连接数据库的密码，推荐使用随机生成的字符串
defined('DB_PASSWORD') or define('DB_PASSWORD', '3344ysb@@373');

//数据库名
defined('DB_NAME') or define('DB_NAME', 'eolinker_backup');
